            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="anggota_id" class="col-md-4 control-label">Buku Yang Dipinjam</label>
                            @foreach($datas as $data)
                                    <div class="col-md-6">
                                        <input id="ket" type="text" class="form-control" name="ket" value="{{ $data->judul }}" readonly="">
                                    </div>
                            @endforeach
                        </div>
                        <div class="form-group{{ $errors->has('ket') ? ' has-error' : '' }}">
                        ...
                        <a href="{{route('peminjaman.index')}}" class="btn btn-danger pull-right">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
