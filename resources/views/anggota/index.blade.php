              ...
              @foreach($datas as $data)
                <tr>
                  ...
                  <td style="text-align:center;">
                    ...
                    <div class="btn-group">
                      <form action="{{ route('anggota.destroy', $data->id)}}" class="delete_form"  method="post">
                        {{ csrf_field() }}
                        {{ method_field('delete') }}
                    ...
                    <div class="btn-group">
                      <a href="{{route('anggota.show', $data->id)}}" class="btn btn-success text-white btn-sm"><i class="fas fa fa-file"></i></a>
                    </div>
                  </td>
                </tr>
              @endforeach
